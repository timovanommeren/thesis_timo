...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   └── 📂prior_Sep_2021
        |       ├── 📂descriptives
        |       |   └── 📜data_stats_prior_Sep_2021.json
        |       ├── 📂state_files
        |       |   ├── 📜sim_prior_Sep_2021_`x`.asreview
        |       |   └── 📜...
        |       └── 📂metrics
        |           ├── 📜metrics_sim_prior_Sep_2021_`x`.json
        |           └── 📜...
        |   └── 📂Sep_2021
        |       ├── 📂descriptives
        ...
        |   ├── 📜tds_sim_prior_Sep_2021.csv
        |   ├── 📜tds_sim_prior_Sep_2021.xlsx
        |   ├── 📜tds_sim_Sep_2021.csv
        |   ├── 📜tds_sim_Sep_2021.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_prior_Sep_2021_metrics.csv
        |   ├── 📜metrics_sim_prior_Sep_2021_metrics.xlsx
        |   ├── 📜metrics_sim_Sep_2021_metrics.csv
        |   ├── 📜metrics_sim_Sep_2021_metrics.xlsx
        |   ├── 📜metrics_summary.csv
        |   └── 📜metrics_summary.xlsx
        └── 📂figures
            ├── 📈plot_recall_prior_Sep_2021.png
