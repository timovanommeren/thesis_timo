...
python scripts\data_describe.py generated_data\dataset_custom_priors.csv -o output\simulation\descriptives\data_stats_generated_data\dataset_custom_priors.csv.json
