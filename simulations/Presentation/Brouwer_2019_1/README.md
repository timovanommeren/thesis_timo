...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   └── 📂prior_Brouwer_2019
        |       ├── 📂descriptives
        |       |   └── 📜data_stats_prior_Brouwer_2019.json
        |       ├── 📂state_files
        |       |   ├── 📜sim_prior_Brouwer_2019_`x`.asreview
        |       |   └── 📜...
        |       └── 📂metrics
        |           ├── 📜metrics_sim_prior_Brouwer_2019_`x`.json
        |           └── 📜...
        ├── 📂tables
        ...
        |   ├── 📜tds_sim_prior_Brouwer_2019.csv
        |   ├── 📜tds_sim_prior_Brouwer_2019.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Brouwer_2019_metrics.csv
        |   ├── 📜metrics_sim_Brouwer_2019_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Brouwer_2019_metrics.csv
        |   ├── 📜metrics_sim_prior_Brouwer_2019_metrics.xlsx
        |   ├── 📜metrics_summary.csv
        |   └── 📜metrics_summary.xlsx
        └── 📂figures
            ├── 📈plot_recall_Brouwer_2019.png
            ├── 📈plot_recall_prior_Brouwer_2019.png
