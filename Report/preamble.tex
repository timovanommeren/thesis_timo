...
\usepackage[hypcap=true]{caption} % Fixes hyperlinking to figures
...
\usepackage{placeins}
% \usepackage[sortcites, style=apa]{biblatex}


% % Bibliography
\usepackage[backend=biber, style=authoryear, sorting=nyt, sortcites]{biblatex}  
