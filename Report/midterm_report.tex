...
A key challenge limiting the application of AI-assisted systematic reviews is the ``cold start'' problem \parencite{van2021open, teijema2025large}. In the context of AI-assisted systematic reviews, the cold start problem refers to the inability of the active learning model to prioritize relevant papers for screening when it has yet to be trained on any examples of relevant papers\footnote{The cold start problem is a well-known issue in recommender systems and active learning more generally \parencite{panda2022approaches, lika2014facing, bobadilla2013recommender}.}. 
...
% Usually, the cold start problem is not a significant issue because researchers can often initialize, or `warm up', the active learning model using \textit{true examples} of relevant papers prior to screening. Moreover, it has been found that  
...
% In this case, the researcher may have to start screening papers at random until a relevant paper has been found which the AI can be trained on. Though starting with screening at random does not seem to affect the overall performance of AI-assisted systematic reviews \parencite{oude2023can}, it may lead to suboptimal \textit{starting performance}. 

% Thus, the cold start problem is a limiting factor to the application of AI-assisted systematic reviews in situations where no prior examples of relevant papers are available and decisions need to be made in a timely manner. Addressing the cold start problem in AI-assisted systematic reviews may therefore contribute to evidence-based decision making in crisis situations such as COVID-19, where rapid reviews which sacrifice rigor for speed are currently the standard \parencite{tricco2020rapid, kurzer2023follow}.
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{results/minimal_recall_plot.png} % adjust path/width
  \caption{Recall plot of AI-assisted screening and manual screening. The x-axis shows the proportion of papers screened (0--1) and the y-axis shows the number of relevant papers found. The blue line shows a simulated screening of the \textit{Appenzeller-Herzog\_2019} dataset with ASReview and the black line shows the expected recall curve when manually screening.}
  \label{fig:minimal-recall-plot}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.9\textwidth}
      \centering
      \includegraphics[width=0.9\linewidth]{../simulation_results/full_run_Appel_Brouwer/Appenzeller-Herzog_2019/aggregate_recall_plot.png}
...
%\clearpage
  ...
  \begin{subfigure}[b]{0.9\textwidth}
      \centering
      \includegraphics[width=0.9\linewidth]{../simulation_results/full_run_Appel_Brouwer/Brouwer_2019/aggregate_recall_plot.png}
      \caption{Recall plot for the Brouwer (2019) dataset}
      \label{fig:full-recall-plot-brouwer}
  \end{subfigure}
  \caption{Aggregate recall plots for two datasets across all four conditions. The x-axis shows the number of papers screened (0--100) and the y-axis shows the number of relevant papers found. Each line shows one run of each condition.}
  \label{fig:full-aggregate-recall-plots}
\end{figure}
\subsection{Comparing starting performance: recall curves for each condition}
\label{sec:full-recall-curves-for-each-condition}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.9\textwidth}
      \centering
      \includegraphics[width=0.9\linewidth]{results/Appelneller_aggregate_recall_plot.png}
      \caption{Recall plot for the Appelneller-Herzog (2019) dataset}
...
%\clearpage
  ...
  \begin{subfigure}[b]{0.9\textwidth}
      \centering
      \includegraphics[width=0.9\linewidth]{results/Brouwer_aggregate_recall_plot.png}
      \caption{Recall plot for the Brouwer (2019) dataset}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=0.9\linewidth]{../Report/results/individual_recall_plots/random/random_run_54_IVs_7_900_0.8_recall_plot.png}
         \caption{Recall true examples condition}
         \label{fig:TrueExamples}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=0.9\linewidth]{../Report/results/individual_recall_plots/no_initialisation/no_initialisation_run_43_IVs_4_900_0.0_recall_plot.png}
         \caption{Recall cold start condition}
         \label{fig:ColdStart}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=0.9\linewidth]{../Report/results/individual_recall_plots/llm/llm_run_7_IVs_1_900_0.0_recall_plot.png}
         \caption{Recall LLM condition}
         \label{fig:LLM}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=0.9\linewidth]{../Report/results/individual_recall_plots/criteria/criteria_run_18_IVs_4_900_0.8_recall_plot.png}
         \caption{Recall criteria-only condition}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.9\textwidth}
      \centering
      \includegraphics[width=0.9\textwidth]{../simulation_results/run_01/Appenzeller-Herzog_2019/aggregate_recall_plot.png}
      \caption{Recall plot for the Appelneller-Herzog (2019) dataset}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.9\textwidth}
      \centering
      \includegraphics[width=0.9\textwidth]{../simulation_results/run_01/Brouwer_2019/aggregate_recall_plot.png}
      \caption{Recall plot for the Brouwer (2019) dataset}
  \end{subfigure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{../Report/images/example_boxplot.png}
...
A limitating factor in the practical application of AI-assisted systematic reviews is the cold start problem. That is, the inability of the AI-models in question to prioritize relevant papers for screening when it has yet to be trained on any examples of relevant papers limits the starting performance of AI-assisted systematic reviews in situations where no prior examples of relevant papers are available. This is especially relevant to crisis situations such as COVID-19, where there may not be relevant prior literature and timely evidence synthesis is crucial.
...
\begin{enumerate}
  ...
  \item Currently, the cold start problem is typically addressed by consulting a domain expert to provide true examples of relevant papers to initialize the model with \parencite{mikkola2024prior}. 
